...
//	}
	...
	public PermanentLicense(int applicantId, String firstName, String lastName,String email, String aadharNo, String mobileNo, 
		 ...
		 String state,String district,String village, String landmark,String pincode,String street,
			Timestamp createdAt, LocalDate appointmentDate, LocalTime appointmentTime, PermanentStatus permanentStatus,
	...
	public String toString() {
		return "PermanentLicense [applicantId=" + applicantId + ", firstName=" + firstName + ", lastName=" + lastName
				...
				+ appointmentDate + ", appointmentTime=" + appointmentTime + ", permanentStatus=" + permanentStatus
