		...
		if (learningRepo.save(ll) != null) {
			emailSenderService.sendSimpleEmail(ll.getEmail(),
					"Dear " + ll.getFirstName() + " " + ll.getLastName() + ",\n\n"
							...
							+ "You can check your application status from the DIGI-DL Portal.\n"
							+ "Mail Regarding test schedule will reach you within 48 hours.\n"
							+ "Wish you the Best of Luck for the test process.\n" + "\n"
							+ "In case you have any query, you can connect with us at rtocdac@gmail.com\n"
							+ "\n" + "Warm Regards,\n" + "DIGI-DL Group,\n" + "DIGI-DL Services",
					"DIGI-DL Learning License Application");
			System.out.println("applied for learning");
			return "Registered Successfully!!";
		}
		
		emailSenderService.sendSimpleEmail(ll.getEmail(), " Failed!! Try Again!!", "DIGI-DL Learning License Application");
